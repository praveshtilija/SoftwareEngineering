...
public class EditItemFragment extends GLMFragment implements View.OnClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (gitem.getItem().isCustom() && !gitem.getItem().getIconDir().contains("types/")){
            imageView.setImageBitmap(Constant.getLocalImage(view, gitem.getItem().getIconDir(), IMAGE_DIMEN));
        }else{
            imageView.setImageBitmap(getImage(view, gitem.getItem()));
        }

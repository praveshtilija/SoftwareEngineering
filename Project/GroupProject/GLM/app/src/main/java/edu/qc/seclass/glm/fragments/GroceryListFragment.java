...
public class GroceryListFragment extends GLMFragment implements View.OnClickListener{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.back_groceryListFragment).setOnClickListener(this);
    ...
    private ImageView getImageView(View view, GroceryItem item) {
        ...
        if (item.getItem().isCustom() && !item.getItem().getIconDir().contains("types/")){
            image.setImageBitmap(Constant.getLocalImage(view, item.getItem().getIconDir(), IMAGE_DIMEN));
        }else{
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.back_groceryListFragment){
            Converter.viewToActivity(v).launchFragment(HomeFragment.getInstance());
        }
